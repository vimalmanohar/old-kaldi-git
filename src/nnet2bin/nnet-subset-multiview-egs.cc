// nnet2bin/nnet-subset-multiview-egs.cc
...
int main(int argc, char *argv[]) {
  try {
    ...
    const char *usage =
        ...
        "\n"
        "Usage:  nnet-subset-multiview-egs [options] <egs-rspecifier> [<egs-wspecifier2> ...]\n"
        "\n"
        "e.g.\n"
        "nnet-subset-multiview-egs [args] ark:- | nnet-subset-multiview-egs --n=1000 ark:- ark:subset.egs\n";
    ...
    NnetMultiviewExampleWriter writer(examples_wspecifier);
